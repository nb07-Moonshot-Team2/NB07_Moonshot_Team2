...
export async function createProject(data: Pick<Project, 'name' | 'description' | 'ownerId'>) : Promise<Project>{
...
export async function updateProject (projectId: string, data: Pick<Project, 'name' | 'description'>) : Promise<Project> {
